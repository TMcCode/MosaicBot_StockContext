...
/** Default: Google. Set `NEXT_PUBLIC_AUTH_OAUTH_PROVIDERS=google,github` for more, or `none` to hide. */
const DEFAULT_PROVIDER_IDS: AuthOAuthProviderId[] = ["google"];
