-- Stock Context — per-page read state (shared Supabase project with stockthemes.ai)
-- Run in Supabase SQL Editor after stockthemes 001_watchlist.sql (profiles trigger already exists).
